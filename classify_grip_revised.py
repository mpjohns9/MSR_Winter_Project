...
train_dir = os.path.join(os.getcwd(),'images/grips/augmented/new_cropped/train')
test_dir = os.path.join(os.getcwd(),'images/grips/augmented/new_cropped/test')


train_loader = get_data_loader(data_dir=train_dir)
test_loader = get_data_loader(data_dir=test_dir, train=False)
...
#         print(loss)
    ...
    # loss_dict[f"epoch {i+1}"] = loss_list
    print()
